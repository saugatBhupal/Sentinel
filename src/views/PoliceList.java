...
public class PoliceList extends JFrame {
    ...
    public PoliceList(App app, List<Police> policeList) {
    ...
    private static JPanel createPanel(Police police) {
        ...
        policeID.setBounds(122, 20, 141, 32);
        panel.add(policeID);
    ...
    public void initialize() {
        ...
        currentPageTitle.setBounds(400, 61, 251, 32);
        ...
        search.addKeyListener(new KeyAdapter() {
            ...
            public void keyPressed(KeyEvent e) {
                if (e.getKeyCode() == KeyEvent.VK_ENTER) {
                    policeController.fullTextSearch(search.getText());
                }
            }
        });
        panel.add(search);
